  ...
  return (
    <div>
      ...
      <div className="calculator-grid">
        ...
        <button className="span-two" onClick={() => dispacth({ type: ACTIONS.CLEAR })}>
          AC
        </button>
        <button onClick={() => dispacth({ type: ACTIONS.DELETE_DIGIT })}>DEL</button>
        ...
        <button className="span-two" onClick={() => dispacth({ type: ACTIONS.EVALUATE })}>=</button>
      </div>
    </div>
  );
}
